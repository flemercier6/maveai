...
export function ExplorePanel({ open, seed, userId, onClose, onMerge, onBranchCreated, onBranchDeleted }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="pr-4 pl-0 pb-[5px] pt-[5px]" style={{ backgroundColor: "#F8F7F5" }}>
        <div
          className={`relative bg-card border border-border rounded-[20px] transition-all duration-200 focus-within:shadow-[0_8px_24px_-4px_hsl(0_0%_0%/0.12)] ${
