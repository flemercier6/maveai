      ...
      <div className="p-2 border-t border-sidebar-border">
        {userEmail ? (
          ...
          <button
            ...
            className="w-full px-3 py-2.5 md:py-2 rounded-[6px] md:rounded-md bg-sidebar text-sidebar-foreground font-semibold hover:bg-sidebar-accent transition-colors text-left text-sm"
          >
