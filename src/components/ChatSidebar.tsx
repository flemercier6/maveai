              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <button
                    ...
                    className="ml-1 h-9 w-9 md:h-7 md:w-7 shrink-0 flex items-center justify-center rounded-[6px] md:rounded-[4px] text-sidebar-foreground hover:bg-sidebar-accent"
                  >
