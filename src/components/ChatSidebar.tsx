        ...
        <div className="mt-2 space-y-0.5">
          <div className="group flex items-stretch w-full">
            <button
              ...
              className="flex-1 flex items-center gap-3 md:gap-2 px-3 md:px-[10px] py-[10px] md:py-[6px] rounded-[6px] md:rounded-md text-sidebar-foreground hover:bg-sidebar-accent text-[15px] md:text-sm"
            >
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <button
                    ...
                    className="ml-1 self-stretch aspect-square shrink-0 flex items-center justify-center rounded-[6px] md:rounded-md text-sidebar-foreground hover:bg-sidebar-accent"
                  >
