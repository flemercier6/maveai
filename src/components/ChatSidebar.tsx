          ...
          {(() => {
            ...
            return (
              <>
                ...
                <Collapsible defaultOpen>
                  <CollapsibleTrigger
                    className="group flex w-full items-center gap-1 px-[10px] py-[6px] font-medium text-foreground text-sm text-muted-foreground hover:text-sidebar-foreground text-base"
                  >
                    <ChevronDown className="w-3 h-3 transition-transform group-data-[state=closed]:-rotate-90" />
                    <span>Recent</span>
                  </CollapsibleTrigger>
