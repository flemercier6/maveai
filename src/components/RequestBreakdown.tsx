      ...
      >
        {meta.models && meta.models.length > 1 ? (
          ...
          <span className="inline-flex items-center pl-1.5">
            <svg viewBox="0 0 310 310" className="w-3 h-3 shrink-0" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
              <path d="M155 0C240.604 0 310 69.3959 310 155C310 240.604 240.604 310 155 310C69.3959 310 0 240.604 0 155C0 69.3959 69.3959 0 155 0ZM165.606 96.6064C159.749 90.7488 150.251 90.7488 144.394 96.6064L96.6064 144.394C90.7488 150.251 90.7488 159.749 96.6064 165.606L144.394 213.394C150.251 219.251 159.749 219.251 165.606 213.394L213.394 165.606C219.251 159.749 219.251 150.251 213.394 144.394L165.606 96.6064Z" />
            </svg>
          </span>
        )}
