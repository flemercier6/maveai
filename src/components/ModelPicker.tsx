...
const NewBadge = () => (
  <span
    className="leading-none rounded-[50px] dark:bg-[#0A1F3F] dark:text-[#4DA3FF]"
    style={{ background: "#F0F6FF", color: "#0062FF", fontSize: "10px", fontWeight: 400, padding: "4px 10px" }}
  >
    New
  </span>
);
