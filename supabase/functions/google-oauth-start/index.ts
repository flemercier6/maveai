// Initiates the Google OAuth flow for the currently authenticated user.
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // state encodes the user id + return URL
    const state = btoa(JSON.stringify({ uid: userId, r: return_to || "" }));
