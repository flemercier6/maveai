...
const PlusBadge = () => (
  <span
    ...
    style={{ background: "#F7EBFF", color: "#9C4CFF", fontSize: "10px", fontWeight: 400, borderRadius: "50px", padding: "3px 5px", gap: "5px" }}
  >
    <svg width="7" height="8" viewBox="0 0 8 9" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ flexShrink: 0 }}>
